...
from ambforecast.forecast import (
    run_single_forecast, run_forecasts, run_cross_validation, forecast_errors
)
...
To evaluate forecast accuracy, use `forecast_errors()`.
...
forecast, errors = run_cross_validation(
